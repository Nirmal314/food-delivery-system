...
export function DataTable<TData, TValue>({
  ...
  //     console.log(table.getRow(i.toString()).original.status);
  //   }
  // }, []);
      ...
      setColumnFilters([
        {
          id: "status",
          value: (row: TData) =>
            statusFilter.includes((row as { status: OrderStatus }).status),
        },
      ]);
    } else {
      setColumnFilters([]);
            ...
            <DropdownMenuContent>
              {Object.values(OrderStatus).map((status, i) => (
                <DropdownMenuItem
                  ...
                  onClick={(e) =>
                    setColumnFilters([
                      { id: "status", value: e.currentTarget.id },
                    ])
                  }
                >
                  {status}
                    ...
                    setColumnFilters([
                      {
                        ...
                        value: (row: TData) =>
                          statusFilter.includes(
                            (row as { status: OrderStatus }).status
                          ),
                      },
                    ]);
                  }}
